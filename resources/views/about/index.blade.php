    ...
    <div class="min-h-screen bg-gradient-to-b from-white to-primary-50">
        <div class="container mx-auto px-6 pt-24 max-w-6xl overflow-hidden">
            ...
            <section class="grid lg:grid-cols-2 gap-16 items-center mb-24">
                ...
                <div class="bg-primary-50/80 backdrop-blur-sm border border-primary-200/50 shadow-lg rounded-2xl p-10 opacity-0 animate-slide-up relative overflow-hidden" style="animation-delay: 0.6s;">
                    ...
                    <ul class="space-y-6 relative">
                        <li class="group transition-all duration-300 lg:hover:-translate-y-1 lg:hover:shadow-lg">
                            <a href="#collections" class="flex items-start p-4 rounded-xl transition-all duration-300 lg:hover:bg-white/50">
                        ...
                        <li class="group transition-all duration-300 lg:hover:-translate-y-1 lg:hover:shadow-lg">
                            <a href="#authors" class="flex items-start p-4 rounded-xl transition-all duration-300 lg:hover:bg-white/50">
                                <div class="relative flex h-14 w-24 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary-100 text-primary-600 transition-all duration-300 ease-in-out lg:group-hover:bg-primary-600 lg:group-hover:text-white me-4">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{__("Connect with your favorite authors and discover new
                                        ones")}}</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="group transition-all duration-300 lg:hover:-translate-y-1 lg:hover:shadow-lg">
                            <a href="#quotes" class="flex items-start p-4 rounded-xl transition-all duration-300 lg:hover:bg-white/50">
                                <div class="relative flex h-14 w-24 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-primary-100 text-primary-600 transition-all duration-300 ease-in-out lg:group-hover:bg-primary-600 lg:group-hover:text-white me-4">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{__("Read and write thoughtful reviews on your reading
                                        experiences")}}</p>
                                </div>
                            </a>
                        </li>
                        ...
                        <li class="group transition-all duration-300 lg:hover:-translate-y-1 lg:hover:shadow-lg">
                            <a href="#quotes" class="flex items-start p-4 rounded-xl transition-all duration-300 lg:hover:bg-white/50">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-600">{{__("Share your reading journey across all your social
                                        platforms")}}</p>
                                </div>
                            </a>
                        </li>
            ...
            <section class="bg-white/70 backdrop-blur-md border border-white/30 shadow-xl rounded-3xl p-16 text-center mb-20 opacity-0 animate-fade-in relative overflow-hidden" style="animation-delay: 0.8s;">
                ...
                <h2 class="text-4xl font-bold text-gray-900 mb-8 relative text-left md:text-center">{{__("Our Commitment")}}</h2>
                ...
                <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 text-left">
                    <div class="bg-white/50 p-6 rounded-2xl shadow-sm transition-all duration-300 lg:hover:shadow-md lg:hover:bg-white/80">
                        ...
                        <p class="text-gray-600">{{__("Carefully curated books and resources to ensure a high standard of
                            quality.")}}</p>
                    </div>
