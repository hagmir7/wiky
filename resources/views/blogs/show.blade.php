    ...
    <div class="flex flex-col lg:flex-row gap-8 relative">
        <div class="w-full max-w-4xl mx-auto">
            <article class="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div class="relative">
                    <img src="{{ $post->getCoverUrl() }}" alt="{{ $post->title }}" class="w-full h-80 md:h-[28rem] object-cover zoom-img">
                    @if(isset($post->category))
                    <span
                        class="absolute top-4 left-4 bg-blue-600 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-md">
                        {{ $post->category->name }}
                    </span>
                    @endif
                </div>
                ...
                <div class="p-6 md:p-8 lg:p-10">
                    ...
                    <div class="animate-fade-in" style="animation-delay: 0.1s">
                        <h1
                            class="text-xl md:text-2xl lg:text-3xl tracking-tight font-extrabold text-gray-900 leading-tight mb-4">
                            {{ $post->title }}
                        </h1>
                    ...
                    <!-- Description -->
                    <div class="animate-fade-in text-xl leading-relaxed text-gray-600 mb-8" style="animation-delay: 0.2s">
                        {!! $post->description !!}
                    </div>

                    <!-- Social Sharing Buttons - Now Floating -->
                    <div class="hidden lg:flex flex-col fixed left-4 top-1/3 space-y-3 z-10 animate-fade-in"
                        ...
                        <button
                            ...
                            aria-label="Copy Link" id="copyLinkBtn">
                    ...
                    <div class="flex flex-wrap gap-2 mb-8">
                        <span
                            class="inline-block px-3 py-1 text-sm text-blue-600 bg-blue-50 rounded-full">#webdevelopment</span>
                        <span
                            class="inline-block px-3 py-1 text-sm text-blue-600 bg-blue-50 rounded-full">#coding</span>
                        <span
                            class="inline-block px-3 py-1 text-sm text-blue-600 bg-blue-50 rounded-full">#laravel</span>
                    </div>
                    @endif
                    ...
                    <div class="mt-12 animate-fade-in" style="animation-delay: 0.5s">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                            ...
                            <a href="{{ route('blogs.show', $post) }}" class="group">
                                <div
                                    class="bg-white rounded-lg shadow-sm border overflow-hidden hover:shadow-lg transition duration-300">
                                    <img src="{{ $post->getCoverUrl() }}" alt="{{ $post->title }}"
                                        class="w-full h-48 object-cover group-hover:scale-105 transition duration-300">
                                    <div class="p-2">
                                        <h3
                                            class="font-semibold text-lg text-gray-800 group-hover:text-blue-600 transition mb-2 mt-0 pt-0">
                            ...
                            @if(empty($posts))
                            <!-- Fallback related posts if not available -->
                            <div
                                class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                                <div class="bg-gray-200 w-full h-48"></div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-800 mb-2">Another interesting article title</h3>
                            ...
                            <div
                                ...
                                <div class="bg-gray-200 w-full h-48"></div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-800 mb-2">Learn more about this topic</h3>
                                    <p class="text-sm text-gray-500">Feb 28, 2025</p>
                                </div>
                            </div>
                            <div
                                class="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition duration-300">
                                <div class="bg-gray-200 w-full h-48"></div>
                                <div class="p-4">
                                    <h3 class="font-semibold text-gray-800 mb-2">Exploring advanced techniques</h3>
                                    <p class="text-sm text-gray-500">Feb 27, 2025</p>
                                </div>
                            </div>
                            @endif
                        </div>
